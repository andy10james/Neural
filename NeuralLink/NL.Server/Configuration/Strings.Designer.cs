...
namespace NL.Server.Configuration {
    ...
    internal class Strings {
        ...
        ///CLS;Clears the console of all text with exception of the command line.;
        ///DISABLECL;Removes and disables the command line from the console.
        ///It is not possible to re-enable the command line after 
        ///this command has been executed without restarting the console.;
        ///DCIP &lt;TARGET IP&gt;;Closes all connections with the target IP address from all servers.;
        ///DCSERVER &lt;TARGET SERVER PORT&gt;;Closes all connections from the target server, and disconnects 
        ///it stopping it from accepting any further connections.;
        ///RCSERVER  [rest of string was truncated]&quot;;.
        /// </summary>
