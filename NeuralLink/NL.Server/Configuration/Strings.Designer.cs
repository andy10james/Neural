...
namespace NL.Server.Configuration {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to CLS;Clears the console of all text with exception of the command line.;DISABLECL;Removes and disables the command line from the console.;DCIP &lt;TARGET IP&gt;;Closes all connections with the target IP address from all servers.;DCSERVER &lt;TARGET SERVER PORT&gt;;Closes all connections on and disconnects the target server.;RCSERVER &lt;TARGET SERVER PORT&gt;;Reconnects the server assigned to the target port, accepting connections.;ADDSERVER &lt;PORT&gt; &lt;CONTROLLER NAME&gt;;Adds a new server to the given port using the remote control [rest of string was truncated]&quot;;.
        /// </summary>
