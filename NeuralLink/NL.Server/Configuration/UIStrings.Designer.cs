...
namespace NL.Server.Configuration {
    ...
    internal class UIStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to CLS;Clears the console of all text with exception of the command line.;DCL;Removes and disables the command line from the console. It is not possible to
        ///re-enable the command line after this command has been executed without 
        ///restarting the console.;DCIP &lt;IP&gt;;Disconnects all connections with the IP address from all servers.;DCSERVER &lt;PORT&gt;;Closes all connections from the server and disables it from accepting any 
        ///further connections.;CSERVER &lt;PORT&gt;;Reconnects the server assigned to the target port, accep [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No servers have been added. .
        /// </summary>
        internal static string NoServersAdded {
            get {
                return ResourceManager.GetString("NoServersAdded", resourceCulture);
            }
        }
